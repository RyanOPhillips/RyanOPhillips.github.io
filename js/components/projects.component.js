(function (){
  ...
  function ProjectsController(){
    ...
    {title: "WaterTracker", description: "A mobile app which allows users to calculate how much water to drink per day based on body weight, and easily track progress towards daily goal", imageURL: "media/icons/WaterTracker-screen.png", link: "https://github.com/RyanOPhillips/WaterTracker"},
